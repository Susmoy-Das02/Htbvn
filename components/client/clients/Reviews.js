      ...
      <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9 ">
        ...
        <div className=" relative md:flex justify-center items-center ">
          ...
          <div className="hidden md:block relative md:w-8/12 w-full overflow-x-hidden md:mt-0 mt-10">
            <div
              id="slider"
              className="flex justify-start items-start transition ease-out duration-700 gap-x-8"
            >
              <Swiper
                slidesPerView={2}
                navigation={
              ...
              >
                <SwiperSlide style={{ width: "100% !important" }}>
                  <div className="w-72 flex-none m-8">
                    <div className="w-full">
                      ...
                      <div className="md:w-full h-full relative">
                        <p className=" text-gray-600 font-normal text-base leading-7">
                          ...
                          not everyone disturbs it The body of suffering is full
                          of fear. I am fully satisfied and would recommend
                          buying from them as they have made my life so much
                          easier :)”
                        </p>
                      </div>
                    </div>
                ...
                <SwiperSlide style={{ width: "100% !important" }}>
                  <div className=" w-72 flex-none m-8 ">
                    <div className=" w-full">
                      ...
                      <p className=" text-gray-600 font-normal text-base leading-7">
                        “ I love this. Thanks. The seeker has solitude. I am
                        fully satisfied and would recommend buying from them as
